...
const Admindashboard = () => {
  ...
  return (
    <div className='bg-zinc-300 min-h-screen min-w-screen flex flex-col items-center justify-center'>
      <h1 className='font-bold text-red-900 text-[40px] m-6'>USER DASHBOARD</h1>
      <Stack
      ...
      >
       ...
       <button className="w-[300px] flex items-center justify-center bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 m-4 rounded"
         ...
         <button className="flex items-center justify-center w-[300px]  bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 m-4 rounded"
