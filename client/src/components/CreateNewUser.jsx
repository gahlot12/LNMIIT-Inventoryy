...
const CreateNewUser = () => {
  ...
  return (
    <div className="h-screen bg-zinc-300 font-bold flex flex-col justify-center ">
      <h1 className="text-center text-[40px] text-red-700 m-1" style={{fontFamily: 'Roboto, sans-serif'}}>Create New User</h1>
      ...
      <div className="bg-white mx-auto w-full font-semibold max-w-md p-8 m-3" style={{fontFamily: 'Figtree, sans-serif'}}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center flex justify-around">
            <button
              type="submit"
              className="mt-4 w-[35%] bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded"
            >
              Create User
            </button>
