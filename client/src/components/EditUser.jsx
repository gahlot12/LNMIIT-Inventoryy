...
const EditUser = ({ setModalVisible, user, setRefresh }) => {
  ...
  return (
    <div className="bg-white font-bold flex flex-col justify-center ">
      <h1 className="text-center text-[40px] text-red-800 m-1">Edit User</h1>
      ...
      <div className="bg-white mx-auto w-full  font-semibold max-w-md p-8">
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center flex justify-around">
            <button
              type="submit"
              className="mt-4 w-[70%] bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded"
            >
              Edit User
            </button>
          </div>
