  ...
  return (
    <div className={`flex ${windowWidth < 1200 ? 'flex-col' : 'flex-row'} min-h-screen items-center justify-center bg-zinc-300`}>
      {windowWidth >= 1200 ? (
            ...
            <div className="flex-1 bg-red-700 h-screen flex items-center justify-center" style={{ transform: 'skewX(-10deg)', transformOrigin: 'top' }}>
      ...
      <div className="flex items-center justify-center flex-1 flex-col h-screen bg-zinc-300" style={{fontFamily: 'Figtree, sans-serif'}}>
        <h1 className="text-3xl font-bold p-10 text-red-700" style={{ cursor: 'pointer',fontFamily: 'Figtree, sans-serif'  }}>
          Admin Login
        </h1>
        <form
        ...
        >
          ...
          <div className='flex items-center justify-around'>
            <button type="submit" className="w-[35%] bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded mt-4">
              Login
            </button>
