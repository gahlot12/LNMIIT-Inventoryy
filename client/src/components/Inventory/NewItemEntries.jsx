  ...
  return (
    <div className=' '>
      ...
      <div className="h-screen  bg-zinc-300 flex flex-col  w-[100%]">
        <h1 className='text-center text-[40px] font-bold text-red-800 m-1'>Item Entries</h1>
        ...
        <div className="max-w-md mx-auto mt-8 w-[100%] flex flex-col items-center justify-center">
          <form onSubmit={handleSubmit} className="w-[80%] bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-around">
              <button
                type="submit"
                className="w-[35%] bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                Submit
              </button>
              <button
