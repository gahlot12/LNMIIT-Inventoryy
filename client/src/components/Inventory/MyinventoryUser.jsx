  ...
  return (
    <div className='bg-zinc-300 flex flex-col items-center'>
     <div className='flex items-center gap-5 w-full justify-center'>
        <h1 className='font-bold text-red-900 text-[40px] m-6 ' style={{ fontFamily: 'Roboto, sans-serif' }}>Inventory</h1>
        <div className='m-6  h-12 w-12 mt-3 bg-red-600 hover:bg-red-800 flex items-center justify-center rounded-[50%]'>
          <Badge max={9}
            badgeContent={cart}
            color="error">
      ...
      <button onClick={()=>{navigate(-1)}} className=' bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-4 rounded mt-4 mb-6'>
        User Dashboard
      </button>
      <div ref={sidebarRef}>
